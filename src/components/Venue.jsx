...
const events = [
  ...
  },
  {
    ...
    details:
      "The Project and Model Expo is an opportunity for students to showcase their innovative creations. Whether it's a technical project or a creative model, participants will present their ideas and prototypes, demonstrating their ingenuity. It's a platform to explore new technologies, exchange ideas, and inspire others.",
  },
  {
    id: 3,
...

  {
    ...
    details:
      "In the Robotics Competition, teams will design, build, and program robots to perform specific tasks and challenges. It's a test of technical skill, teamwork, and creativity, where participants push the boundaries of engineering and robotics to create functional and innovative machines.",
  },
  {
    id: 5,
    title: "Code Crunch",
  ...
  },
  {
    ...
    details:
      "Flavour of India brings the rich diversity of Indian cuisine to life! Participants will showcase traditional and modern dishes from across the country, offering a taste of different cultures, flavors, and culinary techniques. It's a celebration of India’s food heritage, featuring everything from street food to gourmet delights.",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    details:
      "Rider Mania is an exciting event for biking enthusiasts! Whether it's a race, stunt performance, or group ride, participants will show off their riding skills and passion for motorcycles. It’s a celebration of freedom, adventure, and the biking community, bringing together riders from all over.",
  },
  {
    id: 10,
